...
const Footer = () => {
  return (
    <footer className="w-full mb-[40px] pb-10" id="contact">
      <div className="flex flex-col items-center">
        ...
        <a href="mailto:shrivastava.abhishek3112@gmail.com">
          <MagicButton
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
        <p className="md:text-base text-sm md:font-normal font-light pb-4 md:pb-0">
